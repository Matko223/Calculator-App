...
class DateCalculation(QWidget):
    ...
    def frame_layout(self):
        ...
        self.displayFrame.setFixedHeight(505)  # Increased height to accommodate new comboboxes
        ...
        start_date_input_layout = self.create_date_input_layout()
        ...
        end_date_input_layout = self.create_date_input_layout()
        ...
        self.calculateButton.setStyleSheet(
            f"background-color: #4F4F4F; color: white; font-size: 20px; font-weight: bold; border-radius: 15px; margin-top: 15px;")
        self.calculateButton.setFixedSize(130, 50)
        self.calculateButton.clicked.connect(self.calculate)
        frame_layout.addWidget(self.calculateButton, 6, 1, Qt.AlignCenter)

        # Add the resultLabel
        self.resultLabel = QLabel("Result", self.displayFrame)
        self.resultLabel.setStyleSheet(f"color: white; font-size: 25px; font-weight: bold; margin-top: 20px;")
